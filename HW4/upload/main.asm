;====================================================================
;
; Created:   Pzt Eki 31 2019
; Processor: 8086
; Compiler:  MASM32
; Writer: Mustafa Katipoglu
;====================================================================
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
SAVE_INPUT_NUMBER PROC NEAR ;ADDED
   SUB AX, AX
   
   MOV ENCODED_VAL, BH
   CALL FUNC_DECODE_TO_DECIMAL
   ADD Al,THE_DECODED_VAL
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
FUNC_DECODE_TO_DECIMAL PROC NEAR ;ADDED
